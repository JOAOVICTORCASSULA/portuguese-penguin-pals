    ...
    <section id="contact" className="py-20 bg-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="bg-gray-900 p-8 rounded-lg border border-red-600/20">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-400 mt-1">contact@joaobillo.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-400 mt-1">São Paulo, Brasil</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                <a href="#" className="bg-red-600/10 hover:bg-red-600/30 p-2 rounded-full transition-colors">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <Input 
                  ...
                  type="text" 
                  required 
                  className="bg-black border-gray-700 focus:border-red-500 focus:ring-red-500 text-white"
                />
              </div>
